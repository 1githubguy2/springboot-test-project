...
import com.yjl.test_transaction.service.TransactionPropagation;
...
public class TransactionPropagationTest {
	...
	public void testNotransaction_exception_notransaction_notransaction() {
		transactionPropagation.notransaction_exception_notransaction_notransaction();
	}
	...
	public void testNotransaction_notransaction_notransaction_exception() {
		transactionPropagation.notransaction_notransaction_notransaction_exception();
	}
	...
	public void testTransaction_exception_notransaction_notransaction() {
		transactionPropagation.transaction_exception_notransaction_notransaction();
	}
	...
	public void testTransaction_notransaction_notransaction_exception() {
		transactionPropagation.transaction_notransaction_notransaction_exception();
	}
	...
	public void testTransaction_noTransaction_notransaction_exception_try() {
		transactionPropagation.transaction_noTransaction_noTransaction_exception_try();
	}
	...
	public void testNoTransaction() {
		transactionPropagation.notransaction_required_required();
	}
	...
	public void testNotransaction_exception_required_required() {
		transactionPropagation.notransaction_exception_required_required();
	}
	...
	public void testNotransaction_required_required_exception() {
		transactionPropagation.notransaction_required_required_exception();
	}
	...
	public void testTransaction_exception_required_required() {
		transactionPropagation.transaction_exception_required_required();
	}
	...
	public void testTransaction_required_required_exception() {
		transactionPropagation.transaction_required_required_exception();
	}
	...
	public void testTransaction_required_required_exception_try() {
		transactionPropagation.transaction_required_required_exception_try();
	}
	...
	public void testNotransaction_supports_supports_exception() {
		transactionPropagation.notransaction_supports_supports_exception();
	}
	...
	public void testNotransaction_exception_supports_supports() {
		transactionPropagation.notransaction_exception_supports_supports();
	}
	...
	public void testTransaction_supports_supports_exception() {
		transactionPropagation.transaction_supports_supports_exception();
	}
	...
	public void testTransaction_exception_supports_supports() {
		transactionPropagation.transaction_exception_supports_supports();
	}
	...
	public void testNotransaction_exception_requiresNew_requiresNew() {
		transactionPropagation.notransaction_exception_requiresNew_requiresNew();
	}
	...
	public void testNotransaction_requiresNew_requiresNew_exception() {
		transactionPropagation.notransaction_requiresNew_requiresNew_exception();
	}
	...
	public void testTransaction_exception_required_requiresNew_requiresNew() {
		transactionPropagation.transaction_exception_required_requiresNew_requiresNew();
	}
	...
	public void testTransaction_required_requiresNew_requiresNew_exception() {
		transactionPropagation.transaction_required_requiresNew_requiresNew_exception();
	}
	...
	public void testTransaction_required_requiresNew_requiresNew_exception_try() {
		transactionPropagation.transaction_required_requiresNew_requiresNew_exception_try();
	}
	...
	public void testNotransaction_exception_required_notSuppored() {
		transactionPropagation.notransaction_exception_required_notSuppored();
	}
	...
	public void testNotransaction_required_notSuppored_exception() {
		transactionPropagation.notransaction_required_notSuppored_exception();
	}
	...
	public void testTransaction_exception_required_notSuppored() {
		transactionPropagation.transaction_exception_required_notSuppored();
	}
	...
	public void testTransaction_required_notSuppored_exception() {
		transactionPropagation.transaction_required_notSuppored_exception();
	}
	...
	public void testNotransaction_mandatory() {
		transactionPropagation.notransaction_mandatory();
	}
	...
	public void testTransaction_exception_mandatory_mandatory() {
		transactionPropagation.transaction_exception_mandatory_mandatory();
	}
	...
	public void testTransaction_mandatory_mandatory_exception() {
		transactionPropagation.transaction_mandatory_mandatory_exception();
	}
	...
	public void testTransaction_never() {
		transactionPropagation.transaction_never();
	}
	...
	public void testNotransaction_exception_never_never() {
		transactionPropagation.notransaction_exception_never_never();
	}
	/**
	 * 结果：张三（插入），李四（插入）</br>
	 * 外围方法未开启事务，插入“张三”方法和插入“李四”方法也均无事务，任何异常都不会回滚。。
	...
	public void testNotransaction_never_never_exception() {
		transactionPropagation.notransaction_never_never_exception();
	}
	...
	public void testTransaction_exception_nested_nested() {
		transactionPropagation.transaction_exception_nested_nested();
	}
	...
	public void testTransaction_nested_nested_exception() {
		transactionPropagation.transaction_nested_nested_exception();
	}
	...
	public void testNotransaction_exception_nested_nested() {
		transactionPropagation.notransaction_exception_nested_nested();
	}
	...
	public void testnotransaction_nested_nested_exception() {
		transactionPropagation.notransaction_nested_nested_exception();
	}
	...
	public void testTransaction_nested_nested_exception_try() {
		transactionPropagation.transaction_nested_nested_exception_try();
	}
	...
	public void testNotransaction_addRequired_getRequired_get() {
		transactionPropagation.notransaction_addRequired_getRequired_get();
	}
	...
	public void testTransaction_addRequired_getRequired_get() {
		transactionPropagation.transaction_addRequired_getRequired_get();
	}
	...
	public void testTransaction_addRequired_getNested_get() {
		transactionPropagation.transaction_addRequired_getNested_get();
	}
	...
	public void testTransaction_addRequired_getNotSuppored_get() {
		transactionPropagation.transaction_addRequired_getNotSuppored_get();
	}
	...
	public void testTransaction_addRequired_getRequiresNew_get() {
		transactionPropagation.transaction_addRequired_getRequiresNew_get();
	}
